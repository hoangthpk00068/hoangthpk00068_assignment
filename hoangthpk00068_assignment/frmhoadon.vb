...
Public Class frmhoadon
    Dim abc As New SqlConnection("Data Source=HACCONGTU\SQLEXPRESS;Initial Catalog=hoangthpk00068_assignment;Integrated Security=True")
    ...
    Private Sub lsthd_SelectedIndexChanged(sender As Object, e As EventArgs) Handles lsthd.SelectedIndexChanged
        If lsthd.SelectedItems.Count = 1 Then
            For Each lis As ListViewItem In lsthd.SelectedItems
                ...
                txt_tongtien.Text = lis.SubItems(4).Text
    ...
    Private Sub bntthem_Click(sender As Object, e As EventArgs) Handles bntthem.Click
        If (KiemTraThongTin() = True) Then
            Try
                ...
                Dim them As New SqlCommand("Insert into HoaDon(idhd,idsp,idkh,ngayxuat,tongtien,mota) values('" + idhd + "' , N'" + idsp + "','" + idkh + "' ,'" + ngayxuat + "', N'" + tongtien + "',N'" + mota + "')", abc)
    ...
    Private Sub bntxoa_Click(sender As Object, e As EventArgs) Handles bntxoa.Click
        Try
            abc.Open()
            Dim idhd As String = txt_idhd.Text
            Dim xoa As New SqlCommand("delete from HoaDon where idhd ='" + idhd + "'", abc)
            xoa.ExecuteNonQuery()
            abc.Close()
    ...
    Private Sub bntsua_Click(sender As Object, e As EventArgs) Handles bntsua.Click
        Try
            ...
            Dim sua As New SqlCommand("update KhachHang set =  idkh = '" + idkh + "', idsp = '" + idsp + "', ngayxuat = '" + ngayxuat + "', tongtien = '" + tongtien + "', mota = '" + mota + "' where idhd = '" + idhd + "' ", abc)
            sua.ExecuteNonQuery()
            abc.Close()
